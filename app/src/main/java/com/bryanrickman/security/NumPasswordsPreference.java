...
public class NumPasswordsPreference extends DialogPreference implements OnSeekBarChangeListener {
	...
	public NumPasswordsPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
